...
export const StyledText = styled.span.attrs((props) => {
    ...
    if (variant === 'h1')
        return h1VariantProps;
    if (variant === 'h2')
        return h2VariantProps;
    if (variant === 'h3')
        return h3VariantProps;
    if (variant === 'h4')
        return h4VariantProps;
    if (variant === 'important')
        return importantVariantProps;
    if (variant === 'paragraph')
        return paragraphVariantProps;
    if (variant === 'caption')
        return captionVariantProps;
    if (variant === 'sub1')
        return sub1VariantProps;
    if (variant === 'sub2')
        return sub2VariantProps;
}) `
