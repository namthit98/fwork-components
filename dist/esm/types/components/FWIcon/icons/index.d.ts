...
export interface IIconName {
    name: 'add' | 'attachment' | 'chervonleft' | 'crosscircle2' | 'editfilled' | 'export' | 'import' | 'phone' | 'settings' | 'time' | 'trash';
}
export declare type TIconName = 'add' | 'attachment' | 'chervonleft' | 'crosscircle2' | 'editfilled' | 'export' | 'import' | 'phone' | 'settings' | 'time' | 'trash';
